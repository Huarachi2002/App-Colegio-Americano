...
part 'LicenseResponse.g.dart';

abstract class LicenseResponse
    implements Built<LicenseResponse, LicenseResponseBuilder> {
  LicenseResponse._();
  ...
  factory LicenseResponse([updates(LicenseResponseBuilder licenseResponseBuilder)]) =
  _$LicenseResponse;

  static Serializer<LicenseResponse> get serializer => _$licenseResponseSerializer;
}
