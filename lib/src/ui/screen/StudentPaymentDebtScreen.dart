...
import 'package:colegio_americano/src/ui/view_model/StudentPaymentDebtScreenViewModel.dart';
...
class StudentPaymentDebtScreen extends StatefulWidget {
  @override
  State<StatefulWidget> createState() => _StudentPaymentDebtScreenState();
}

class _StudentPaymentDebtScreenState extends State<StudentPaymentDebtScreen>
    with RootScreenMixin {
  StudentPaymentDebtScreenViewModel _viewModel =
      StudentPaymentDebtScreenViewModel();
          ...
          itemBuilder: (BuildContext context, int index) {
            return GestureDetector(
              onTap: () {
                ...
                _viewModel.navigation.startDebtListScreen(
                    context,
  ...
  _appBar(BuildContext context) {
    return AppBar(
      title: Text(AppLocalizations.of(context).translate('menu_title_payment')),
    );
  }
}
