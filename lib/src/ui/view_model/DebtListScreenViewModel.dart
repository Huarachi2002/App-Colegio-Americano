...
class DebtListScreenViewModel extends BaseViewModel {
  ...
  DebtListScreenViewModel() : super() {
    ...
    _invoiceDataStreamController = BehaviorSubject<Tuple5<String, String, String, int, String>>();
  }
  ...
  Function(Tuple5<String, String, String, int, String>) get invoiceDataStreamSink =>
      _invoiceDataStreamController.sink.add;
  ...
  Future<void> getDebtList(BuildContext context, String erpCode) async {
    ...
    try {
      ...
      var response = await Utils.retryFuture(
          SyncConstants.ATTEMPTS, () => apiService.getPendingDebts(erpCode)
      );
      ...
      //TODO: Get currency from API DocumentType, Complement
      ...
      if (data != null) {
        invoiceDataStreamSink(Tuple5(businessName, nit, currency, documentType, complement));
  ...
  updateInvoiceData(String? businessName, String? nit, String currency, int? documentType, String? complement) {
    ...
    invoiceDataStreamSink(Tuple5(this.businessName, this.nit, this.currency, this.documentType, this.complement));
  }
